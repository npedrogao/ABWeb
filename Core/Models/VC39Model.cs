...
namespace Core.Models
{
    ...
    public class VC39Model
    {
        ...
        public virtual string Gmoe
        {
            get;
            set;
        }

        public virtual string Cbal
        {
            get;
            set;
        }

        public virtual string Ncta
        {
            get;
            set;
        }
        ...
        public virtual string ComDistrib
        {
            get;
            set;
        }
