...
namespace Core.Logging.Log.SharpZipLib.Tar
{
    ...
    public class TarHeader : ICloneable
    {
        ...
        public void WriteHeader(byte[] outBuffer)
        {
            ...
            offset = GetLongOctalBytes(lSize, outBuffer, offset, SIZELEN);
            offset = GetLongOctalBytes(GetCTime(this.ModTime), outBuffer, offset, MODTIMELEN);
        ...
        public override bool Equals(object obj)
        {
            ...
            return localHeader != null && (this.name == localHeader.name
