...
namespace Core.Logging.Log.SharpZipLib.Tar
{
    ...
    public class TarOutputStream : Stream
    {
        ...
        {
            return this.outputStream.Read(inBuffer, offset, count);
        }
        ...
        public void CloseEntry()
        {
            ...
            {
                Array.Clear(this.assemblyBuffer, this.assemblyBufferLength,
                            this.assemblyBuffer.Length - this.assemblyBufferLength);
        ...
        public override void Write(byte[] inBuffer, int offset, int count)
        {
            ...
            if (inBuffer.Length - offset < count)
            {
            ...
            if (this.assemblyBufferLength > 0)
            {
                if ((this.assemblyBufferLength + count) >= this.blockBuffer.Length)
                {
                    ...
                    Array.Copy(inBuffer, offset, this.blockBuffer, this.assemblyBufferLength, aLen);
                ...
                {
                    Array.Copy(inBuffer, offset, this.assemblyBuffer, this.assemblyBufferLength, count);
                    offset += count;
            ...
            while (count > 0)
            {
                ...
                this.buffer.WriteBlock(inBuffer, offset);
