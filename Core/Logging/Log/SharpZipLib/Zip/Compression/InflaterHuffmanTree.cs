...
namespace Core.Logging.Log.SharpZipLib.Zip.Compression
{
    ...
    public class InflaterHuffmanTree
    {
        ...
        /// Distance tree
        /// </summary>
        internal static InflaterHuffmanTree defDistTree = InitDefDistTree();

        /// <summary>
        /// Literal length tree
        /// </summary>
        internal static InflaterHuffmanTree defLitLenTree = InitDefLitLenTree();

        private static InflaterHuffmanTree InitDefDistTree( )
        {
            try
            {
        ...
        private static InflaterHuffmanTree InitDefLitLenTree( )
        {
            try
            {
