...
namespace Core.Logging.Log.SharpZipLib.Zip
{
    ...
    internal class ZipHelperStream : Stream
    {
                                               ...
                                               long startOfCentralDirectory, byte[] comment)
        {
            ...
            {
                this.WriteLEInt((int) sizeEntries); // size of the central directory
            }

            // Zip64
            if (startOfCentralDirectory >= 0xffffffff)
            {
                this.WriteLEUint(0xffffffff); // offset of start of central dir
            }
            else
            {
                this.WriteLEInt((int) startOfCentralDirectory); // offset of start of central dir
            }
            ...
            if( ( null != comment ) && ( commentLength > 0 ) )
            {
