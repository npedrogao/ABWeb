...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <div class="content">
        ...
        <div class="panel-content container-fluid form-horizontal">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCProduto" runat="server" CssClass="col-sm-2 col-md-2 control-label">Produto:</asp:Label>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCSubProd" runat="server" CssClass="col-sm-2 col-md-2 control-label">Sub Produto:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCClaPrz" runat="server" CssClass="col-sm-2 col-md-2 control-label">Classe:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCMOEDA" runat="server" CssClass="col-sm-2 col-md-2 control-label">Moeda:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblGESTADO" runat="server" CssClass="col-sm-2 col-md-2 control-label">Estado:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblDINIVAL" runat="server" CssClass="col-sm-2 col-md-2 control-label">Data de Início:</asp:Label>
                            <div class="col-sm-4 col-md-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblDFIMVAL" runat="server" CssClass="col-sm-2 col-md-2 control-label">Data de Fim:</asp:Label>
                            <div class="col-sm-4 col-md-4">
            ...
            <br />
            <div class="col-sm-12 titleAccordion">
            ...
            <div class="row hidden">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblIPRZABS" runat="server" class="col-sm-2 col-md-2 control-label">Prazo Absoluto:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                                <asp:TextBox ID="txtIPRZABS" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCPRODCNT" runat="server" class="col-sm-2 col-md-2 control-label">Prod/SubP Contab:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCFINBB" runat="server" class="col-sm-2 col-md-2 control-label">Finalidade Bankinter:</asp:Label>
                            <div class="col-sm-2 col-md-2">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblIIRS" runat="server" CssClass="col-sm-2 col-md-2 control-label">Declaração IRS:</asp:Label>
                            <div class="col-sm-4 col-md-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblITRANCHE" runat="server" CssClass="col-sm-2 col-md-2 control-label">Rep. Tranches:</asp:Label>
                            <div class="col-sm-4 col-md-4">
                                <asp:TextBox ID="txtITRANCHE" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <asp:Label ID="lblCAGREGDP" runat="server" CssClass="col-sm-2 col-md-2 control-label">Cód. Agregado:</asp:Label>
                            <div class="col-sm-4 col-md-4">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblIRenovac" runat="server" class="col-sm-2 col-md-2 control-label">Renovações Automáticas:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <select id="cmbIRenovac" runat="server" class="form-control t-field-t"></select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbQMAXREN" runat="server" class="col-sm-2 col-md-2 control-label">Nr. Máximo Renovações:</asp:Label>
                        <div class="col-sm-4 col-md-4">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblILEVANT" runat="server" class="col-sm-4 col-md-4 control-label">Mobilização Antecipada:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <asp:TextBox ID="TXTILEVANT" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblIAUTREF" runat="server" class="col-sm-4 col-md-4 control-label">Reforço Autorizado:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblIDiaNUt" runat="server" class="col-sm-4 col-md-4 control-label">Dias Não Úteis:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <select id="cmbIDiaNUt" runat="server" class="form-control t-field-t"></select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblQDiasAnt" runat="server" class="col-sm-4 col-md-4 control-label">Dias Antecipação:</asp:Label>
                        <div class="col-sm-4 col-md-4">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbIIDEBFOR" runat="server" class="col-sm-4 col-md-4 control-label">Débito forçado:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <select id="cmbIIDEBFOR" runat="server" class="form-control t-field-t"></select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblQTENTDEB" runat="server" class="col-sm-4 col-md-4 control-label">Nr. Tentativas:</asp:Label>
                        <div class="col-sm-4 col-md-4">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblIPRCLNEW" runat="server" class="col-sm-4 col-md-4 control-label">Prod. Novo Cliente:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <select id="cmbIPRCLNEW" runat="server" class="form-control t-field-t"></select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblQDIASNCLI" runat="server" class="col-sm-4 col-md-4 control-label">Nr. Dias Novo Cliente:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblCCAMPNET" runat="server" class="col-sm-4 col-md-4 control-label">Campanha Excepção:</asp:Label>
                        <div class="col-sm-2 col-md-2">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblCCXSCONS" runat="server" class="col-sm-2 col-md-2 control-label">Constituição:</asp:Label>
                        <div class="col-sm-2 col-md-2">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblCCXSVENC" runat="server" class="col-sm-2 col-md-2 control-label">Vencimento:</asp:Label>
                        <div class="col-sm-2 col-md-2">
            ...
            <div class="row hidden">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCSUBFAM" runat="server" class="col-sm-2 col-md-2 control-label">SubFamília:</asp:Label>
                        <div class="col-sm-2 col-md-2">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCLIQUIDPROD" runat="server" class="col-sm-2 col-md-2 control-label">Liquidez:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCCOMPLEXINV" runat="server" class="col-sm-2 col-md-2 control-label">Complexidade:</asp:Label>
                        <div class="col-sm-2 col-md-2">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCHORIZON" runat="server" class="col-sm-2 col-md-2 control-label">Horizonte Temporal:</asp:Label>
                        <div class="col-sm-2 col-md-2">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCZONGEOG" runat="server" class="col-sm-2 col-md-2 control-label">Zona Geográfica:</asp:Label>
                        <div class="col-sm-2 col-md-2">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCONOFFREGU" runat="server" class="col-sm-2 col-md-2 control-label">OnOff/Regular:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCIPAD" runat="server" class="col-sm-2 col-md-2 control-label">iPAD:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <asp:TextBox ID="txtCIPAD" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCNIVELRISCO" runat="server" class="col-sm-2 col-md-2 control-label">Nivel Risco:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbMVAR" runat="server" class="col-sm-2 col-md-2 control-label">VaR:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <asp:TextBox ID="txtMVAR" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbDVAR" runat="server" class="col-sm-2 col-md-2 control-label">Data:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbGOBSRV" runat="server" class="col-sm-2 col-md-2 control-label">Descrição:</asp:Label>
                        <div class="col-sm-6 col-md-6">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCCLAACTI" runat="server" class="col-sm-2 col-md-2 control-label">Cat./Class.activ.:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                            <asp:TextBox ID="txtCCLAACTI" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lbCCLASSRISC" runat="server" class="col-sm-2 col-md-2 control-label">Solicitar classificação de Risco:</asp:Label>
                        <div class="col-sm-4 col-md-4">
                ...
                <div class="row form-group padding-row">
                    <div class="col-sm-6 col-md-6">
                        <asp:Label ID="lblDTACTIVA" runat="server" class="col-sm-2 col-md-2 control-label">Data de Activação:</asp:Label>
                        <div class="col-sm-4 col-md-4">
