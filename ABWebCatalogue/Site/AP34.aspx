                ...
                <div class="col-lg-12 col-xs-12">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblCProduto" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Produto:</asp:Label>
                        ...
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblCSubProd" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Sub Produto:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblCClaPrz" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Classe:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                        ...
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblCMOEDA" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Moeda:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                    ...
                    <div id="pnlGESTADO" runat="server" class="row form-group padding-row hidden">
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblGESTADO" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Estado:</asp:Label>
                    ...
                    <div id="pnlDFIMVAL" runat="server" class="row form-group padding-row hidden">
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblDINIVAL" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Data de Início:</asp:Label>
                            <div class="col-lg-2 col-xs-2">
                                <asp:TextBox runat="server" ID="txtDINIVAL" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6">
                            <asp:Label ID="lblDFIMVAL" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Data de Fim:</asp:Label>
                            <div class="col-lg-2 col-xs-2">
            ...
            <div id="pnlSearchContent" runat="server" class="hidden">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIPRZABS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Prazo Absoluto:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <select id="cmbIPRZABS" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCPRODCNT" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Prod/SubP Contab:</asp:Label>
                                <div class="col-lg-1 col-xs-1">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCFINBB" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Finalidade Bankinter:</asp:Label>
                                <div class="col-lg-1 col-xs-1">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIIRS" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbll">Declaração IRS:</asp:Label>
                                <div class="col-lg-1 col-xs-1">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblITRANCHE" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Rep. Tranches:</asp:Label>
                                <div class="col-lg-1 col-xs-1">
                                    <select id="cmbITRANCHE" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCAGREGDP" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Cód. Agregado:</asp:Label>
                                <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblIRenovac" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Renovações Automáticas:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <select id="cmbIRenovac" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblQMAXREN" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Nr. Máximo Renovações:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblILEVANT" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Mobilização Antecipada:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <select id="cmbILEVANT" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblIAUTREF" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Reforço Autorizado:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblIDiaNUt" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Dias Não Úteis:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <select id="cmbIDiaNUt" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblQDiasAnt" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Dias Antecipação:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblIDEBFOR" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Débito forçado:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <select id="cmbIDEBFOR" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblQTENTDEB" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Nr. Tentativas:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblIPRCLNEW" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Prod. Novo Cliente:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <select id="cmbIPRCLNEW" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblQDIASNCLI" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Nr. Dias Novo Cliente:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCAMPNET" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Campanha Excepção:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCXSCONS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Constituição:</asp:Label>
                            <div class="col-lg-1 col-xs-1 ">
                        ...
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCXSVENC" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Vencimento:</asp:Label>
                            <div class="col-lg-1 col-xs-1 ">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCSUBFAM" runat="server" class="col-lg-2 col-xs-2 text-right lbl">SubFamília:</asp:Label>
                            <div class="col-lg-1 col-xs-1 ">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCOMPLEXINV" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Complexidade:</asp:Label>
                            <div class="col-lg-2 col-xs-2 ">
                        ...
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCHORIZON" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Horizonte Temporal:</asp:Label>
                            <div class="col-lg-2 col-xs-2 ">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCZONGEOG" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Zona Geográfica:</asp:Label>
                            <div class="col-lg-2 col-xs-2 ">
                        ...
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCONOFFREGU" runat="server" class="col-lg-2 col-xs-2 text-right lbl">OnOff/Regular:</asp:Label>
                            <div class="col-lg-4 col-xs-4 ">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCIPAD" runat="server" class="col-lg-2 col-xs-2 text-right lbl">iPAD:</asp:Label>
                            <div class="col-lg-1 col-xs-1 ">
                                <asp:TextBox ID="txtCIPAD" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCNIVELRISCO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Nivel Risco:</asp:Label>
                            <div class="col-lg-4 col-xs-4 ">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblMVAR" runat="server" class="col-lg-2 col-xs-2 text-right lbl">VaR:</asp:Label>
                            <div class="col-lg-2 col-xs-2 ">
                                <asp:TextBox ID="txtMVAR" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblDVAR" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Data:</asp:Label>
                            <div class="col-lg-2 col-xs-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblGOBSRV" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Descrição:</asp:Label>
                            <div class="col-lg-6 col-xs-6 ">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCLAACTI" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Cat./Class.activ.:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                                <asp:TextBox ID="txtCCLAACTI" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCCLASSRISC" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Solicitar classificação de Risco:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblDTACTIVA" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Data de Activação:</asp:Label>
                            <div class="col-lg-2 col-xs-2 ">
