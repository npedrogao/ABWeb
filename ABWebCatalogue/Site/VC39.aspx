            ...
            <div id="pnlSearchContent" runat="server" class="hidden">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCSEQUEN" runat="server" class="col-lg-2 col-xs-2 text-right lbl"></asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIMETRESG" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">METODO DE RESGATE:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIPRODASS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Produto Associado:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCIPAD" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Disponível na APP de Investimento:</asp:Label>
                                         <div class="col-lg-1 col-xs-1">
