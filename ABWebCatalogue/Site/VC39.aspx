                ...
                <div class="col-lg-12 col-xs-12">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCPRODUTO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Produto</asp:Label>
                            <div class="col-lg-4 col-xs-4">
                                <asp:TextBox ID="txtCPRODUTO" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-6 ">
                            <asp:Label ID="lblCSUBPROD" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Sub Produto</asp:Label>
                            <div class="col-lg-4 col-xs-4">
                    ...
                    <div id="pnlVC" runat="server" class="hidden">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblGSUBPROD" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Nome</asp:Label>
                                <div class="col-lg-4 col-xs-4">
            ...
            <div id="pnlSearchContent" runat="server" class="hidden">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCTIPOSG" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tipo Produto</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCMOEDA" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Moeda</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCBALCAO1" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Conta Produto</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCAPOANO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">CAPOANO</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblZAPOLICE" runat="server" class="col-lg-2 col-xs-2 text-right lbl">ZAPOLICE</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtZAPOLICE" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCERTIF" runat="server" class="col-lg-2 col-xs-2 text-right lbl">CCERTIF</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCERANO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">CCERANO</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtCCERANO" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCBALSACO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Conta IT'S</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCBANNIB" runat="server" class="col-lg-2 col-xs-2 text-right lbl">NIB da Conta GV</asp:Label>
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQBASCALC" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Base Cálculo</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtQBASCALC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCSEQUEN" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Base Cálculo</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQDECIUPS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Decimais UP'S</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtQDECIUPS" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQALTMOD" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Número de Alterações</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQPROPVAL" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Validade Propostas (Dias):</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtQPROPVAL" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCTIPODIAS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Dias úteis:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQANOMIN" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Minimo (Anos|Dias):</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQANOMAX" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Maximo (Anos|Dias):</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblDVENCIM" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Data De Vencimento:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblTBONEMP" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Bonific. (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtTBONEMP" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblTCOMISS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Comissão (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblTPARRESG" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Par.Resg. (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtTPARRESG" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblTGARANT" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Garant. (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblTPENTRFO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Pen.Trfo (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtTPENTRFO" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblMRESGMIN" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Vl.Resg.Min. (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12 ">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblPCOMDIS" runat="server" class="col-lg-4 col-xs-4 text-right lbl">Comissão de Distribuição:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQIDADMIN" runat="server" class="col-lg-3 col-xs-3 text-right lbl">Idade Minima (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtQIDADMIN" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQIDADMAX" runat="server" class="col-lg-3 col-xs-3 text-right lbl">Idade Máxima (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQIDADDEF" runat="server" class="col-lg-3 col-xs-3 text-right lbl">Idade Default (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtQIDADDEF" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQIDADSUB" runat="server" class="col-lg-3 col-xs-3 text-right lbl">Idade Max. Subs. (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblNPESSSEG" runat="server" class="col-lg-3 col-xs-3 text-right lbl">Nº Pessoas Seguras (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCTRATADO" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Cód. Tratado (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblMCACTA" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Acta (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtMCACTA" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblMCAPOL" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Apólice (%):</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            ...
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">PREM</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">RESG.T</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">RESG.P</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">RED.T</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">RED.P</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">SIN</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">TRANSFO</asp:Label>
                            <asp:Label class="col-lg-1 col-xs-1 text-center lbl">TRANSFE</asp:Label>
                        </div>
                        <div class="row form-group padding-row">
                            <asp:Label ID="Label1" runat="server" class="col-lg-2 col-xs-2 text-right lbl">CLI:</asp:Label>
                        ...
                        <div class="row form-group padding-row">
                            <asp:Label ID="Label2" runat="server" class="col-lg-2 col-xs-2 text-right lbl">SOC:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                        ...
                        <br />
                        <div class="row form-group padding-row">
                            <asp:Label ID="lblTPARESG1" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Tx.Penalização (%):</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                        ...
                        <div class="row form-group padding-row">
                            <asp:Label ID="lblQANORES1" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Até (Ano):</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                        ...
                        <div class="row form-group padding-row">
                            <asp:Label ID="lblDPRESG1" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Data:</asp:Label>
                            <div class="col-lg-1 col-xs-1">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-1 col-xs-12 col-xs-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblICOBPPP" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Prod.c/ PPP:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCOPERSGPPP" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">COPERSG PPP:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblSUBPFUND" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">SubProduto:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtSubpfund" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCBALFUND" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Conta:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6">
                                <asp:Label ID="lblQPRORROG" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Anos:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Validade de Duração de Contrato:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIvaldur" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIBASECAL" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Base de Cálculo:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblITIPOREV" runat="server" class="col-lg-2 col-xs-2 text-right lbl">TIPO DE REVALORIZAÇÃO DE CAPITAL</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbITIPOREV" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCTABREV" runat="server" class="col-lg-2 col-xs-2 text-right lbl">COD. TABELA DE REVALORIZAÇÃO :</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIMETRESG" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">METDO DE RESGATE:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIMETRESG" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblICAPTLZ" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">CAPITALIZACAO :</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblPVLSUBS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Perc.Capital a Investir (%):</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtPVLSUBS" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="Label4" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Extração p/Automatismo:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIEXTRAUT" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCONTSGC" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Carteira SGC:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtCCONTSGC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtCBALCSGC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-3 col-xs-3">
                                    <asp:TextBox ID="txtZCLISGC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-1 col-xs-1">
                                    <asp:TextBox ID="txtCPRODSGC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCSUBPINV" runat="server" class="col-lg-2 col-xs-2 text-right lbl">SubProduto a Investir:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtCSUBPINV" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblQIPCVAL" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Validade da IPC (dias):</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtQIPCVAL" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="Label8" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Dias úteis:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbCTIPODIPC" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCGRUPTCLN" runat="server" class="col-lg-6 col-xs-6 text-right lbl">Código do Agrupamento de Acumulação de Capital:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <asp:TextBox ID="txtCGRUPTCLN" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIENCCAP" runat="server" class="col-lg-6 col-xs-6 text-right lbl">Valor dos encargos acrescido ao valor de subcrição:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIENCCAP" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblIPRODASS" runat="server" class="col-lg-4 col-xs-4 text-right lbl">Produto Associado:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIPRODASS" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCPRODSGASS" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Código Produto Associado:</asp:Label>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtCPRODSGASS" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-2 col-xs-2">
                                    <asp:TextBox ID="txtCSPRDSGASS" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-3 col-xs-3">
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="Label13" runat="server" class="col-lg-6 col-xs-6 text-right lbl">Deseja efectuar o cálculo de juro?</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIRECALJUR" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="Label14" runat="server" class="col-lg-4 col-xs-4 text-right lbl">Indicador DPM?</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbIDPM" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row hidden closeAccordion colorbck">
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCSUBFAM" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">SubFamilia:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCLIQUIDPROD" runat="server" class="col-lg-2 col-xs-2 text-right lbl">Liquidez:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCOMPLEXINV" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Complexidade:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCHORIZON" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Horizonte Temporal:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCZONGEOG" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Zona Geográfica:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                            ...
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCONOFFREGU" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">OnOff/Regular:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCIPAD" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">iPAD:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbCIPAD" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCNIVELRISCO" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Nivel Risco:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblMVAR" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">VaR:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblGOBSRV" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Descrição:</asp:Label>
                                <div class="col-lg-6 col-xs-6">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCLAACTI" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Cat./Class.activ.:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblCCLASSRISC" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Solicitar classificação de Risco:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
                                    <select id="cmbCCLASSRISC" runat="server" class="form-control t-field-t"></select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-6 ">
                                <asp:Label ID="lblDisponível" runat="server" CssClass="col-lg-2 col-xs-2 text-right lbl">Disponível na APP de Investimento:</asp:Label>
                                <div class="col-lg-4 col-xs-4">
