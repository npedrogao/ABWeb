                ...
                <div class="col-lg-12">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            ...
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCPRODUTO" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCSUBPROD" runat="server" class="col-lg-2 text-right lbl">SubProduto:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCSUBPROD" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            ...
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCISIN" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                        </div>
                    ...
                    <div id="pnlCA" runat="server" class="hidden">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCMOEDA" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblCESTADO" runat="server" class="col-lg-2 text-right lbl">Estado do Fundo:</asp:Label>
                                <div class="col-lg-4">
                                    <select id="cmbCESTADO" runat="server" maxlength="2" class="form-control t-field-t"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtanti" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lbAntigoSubProduto" runat="server" class="col-lg-2 text-right lbl">Antigo SubProduto:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtAntigoSubProduto" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtClasseFundo" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblGSUBPR50" runat="server" class="col-lg-2 text-right lbl">Nome:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtGSUBPR50" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtGSUBPROD" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblNomeLongo" runat="server" class="col-lg-2 text-right lbl">Nome Longo:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtNomeLongo" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCCLASSACT" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCCLASSACTFU" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCTIPACTIVO" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCAREAGEOG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCRANGE" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCZONGEOG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCTIPFU" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCIDSOCGEST" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblGSGC" runat="server" class="col-lg-2 text-right lbl">Nome Soc. Gestora:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtGSGC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCPAISSG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblCPAISISO" runat="server" class="col-lg-2 text-right lbl">Pais Emissão do Fundo:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCPAISISO" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCSICAV" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblCPAISICAV" runat="server" class="col-lg-2 text-right lbl">Pais SICAV:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCPAISICAV" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCSICAVDOM" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblNSICAV" runat="server" class="col-lg-2 text-right lbl">Nome SICAV:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtNSICAV" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCNIFEMITE" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtDKIID" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtTOGC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtIPRDPGDIV" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPRETDIV" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCMOETRFEES" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPOPAG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblIDECMTE" runat="server" class="col-lg-2 text-right lbl">Decimais Montantes:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtIDECMTE" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBLOOM" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtDecQtds" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                        ...
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCINDSELO" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBOPER" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBALADIC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label37" runat="server" class="col-lg-2 text-right lbl">Informa Banco de Portugal:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtInfBancoPortugal" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtClienteObrig" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCGRUPEST" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISGEST" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblITIPOCOMSG" runat="server" class="col-lg-2 text-right lbl">Tipo comissão Soc. gestora:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPOCOMSG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox5" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblPCOMISDIST" runat="server" class="col-lg-2 text-right lbl">Comissão Distribuição:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISDIST" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQCOMISUGES" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label44" runat="server" class="col-lg-2 text-right lbl">Comissão Máx Resgate:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox8" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISRESG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label46" runat="server" class="col-lg-2 text-right lbl">Comissão de Desempenho:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox10" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox11" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblPCOMISTOT" runat="server" class="col-lg-2 text-right lbl">Comissão total:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISTOT" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPOCOMFU" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label50" runat="server" class="col-lg-2 text-right lbl">Custos de Auditoria:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox14" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISDEP" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblQCOMISUFUND" runat="server" class="col-lg-2 text-right lbl">Comissão subscrição de fundo:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQCOMISUFUND" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox17" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblPCOMISADM" runat="server" class="col-lg-2 text-right lbl">Comissão de administração:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtPCOMISADM" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQCOMIRGFUND" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtICOTREDE" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtIDECCOT" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtHCUTSUBS" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblMPRISUBC" runat="server" class="col-lg-2 text-right lbl">Mont. mínimo 1º Subscrição:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtMPRISUBC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtHCUTRESG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblMMINSUBC" runat="server" class="col-lg-2 text-right lbl">Mont. mínimo  Subscrição:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtMMINSUBC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtTREPCOMS" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblQMINSUBSGA" runat="server" class="col-lg-2 text-right lbl">Mínimo Subscrição GA:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQMINSUBSGA" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtTREPCOMR" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblQPOSMINC" runat="server" class="col-lg-2 text-right lbl">Posição mínima:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQPOSMINC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQPOSMAXC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox31" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPOSETTSUB" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblQDIASUBSC" runat="server" class="col-lg-2 text-right lbl">Dias p/ Notificações Subs:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQDIASUBSC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtITIPOSETTRES" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblIDIASUBSC" runat="server" class="col-lg-2 text-right lbl">Tipo dias Notificações Subs:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtIDIASUBSC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtINRESG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtQDIARESG" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-6 ">
                                    <asp:Label ID="Label77" runat="server" class="col-lg-2 text-right lbl">Tipo dias Notificação Resg:</asp:Label>
                                    <div class="col-lg-4">
                                        <asp:TextBox ID="TextBox39" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBALJDC" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBALSACO" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBALCOM" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCBALMOE" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtGOBSRVMOT" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label96" runat="server" class="col-lg-2 text-right lbl">ESTAT:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox69" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox70" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label98" runat="server" class="col-lg-2 text-right lbl">Ordem:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox71" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox72" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label100" runat="server" class="col-lg-2 text-right lbl">ROT. COT:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox73" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtMNOMIN" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label102" runat="server" class="col-lg-2 text-right lbl">PER.EXT.:</asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBox75" runat="server" MaxLength="2" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                ...
                                <div class="col-lg-4">
                                    <asp:TextBox ID="txtCCLASSRISC" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6 ">
