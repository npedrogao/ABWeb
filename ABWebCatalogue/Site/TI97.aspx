...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <div class="content">
        <div class="titleTransaction">
            <asp:Label ID="lblTransaction" runat="server"> TI97 </asp:Label>
        </div>
        <div class="container-fluid form-horizontal">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblCODVALOR" runat="server" class="col-lg-2 text-center lbl">Espécie:</asp:Label>
                                <div class="col-lg-2">
                            ...
                            <div class="col-lg-6 ">
                                <asp:Label ID="lblSEGCART" runat="server" class="col-lg-2 text-center lbl">Seg. Carteira:</asp:Label>
                                <div class="col-lg-2">
                        ...
                        <div class="row form-group padding-row">
                            ...
                            <div class="col-lg-4 text-right">
                                ...
                                <button id="searchButton" class="btnCollapse" runat="server" onserverclick="btnSearchButton_Click">Pesquisar</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblSITUACA" runat="server" class="col-lg-2 text-center lbl"></asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCTIPESC" runat="server" class="col-lg-2 text-center lbl">Escalão Prec.:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCODISIN" runat="server" class="col-lg-2 text-center lbl">ISIN:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCODISIN" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblNEMONICA" runat="server" class="col-lg-2 text-center lbl">CVM:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCCIF_2" runat="server" class="col-lg-2 text-center lbl">Class.I.Fin.:</asp:Label>
                            <div class="col-lg-4">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCBLOOMBG" runat="server" class="col-lg-2 text-center lbl">Bloomberg:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCREUTERS" runat="server" class="col-lg-2 text-center lbl">Reuters:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCREUTERS" runat="server" size="1" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCPFCCMVM" runat="server" class="col-lg-2 text-center lbl">CMVM PFC:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblITITDEF" runat="server" class="col-lg-2 text-center lbl">Default:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbITITDEF" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCODDIVI" runat="server" class="col-lg-2 text-center lbl">Moed+Nomimal:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblNOMIN" runat="server" class="col-lg-2 text-center lbl">Nominal Ant.:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtNOMIN" runat="server" size="1" CssClass="form-control t-field-t medium-input"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblAMORPARC" runat="server" class="col-lg-2 text-center lbl">Amort. Parcial sem Afeta Nom/Quant.:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblNIF" runat="server" class="col-lg-2 text-center lbl">Contribuinte:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtNIF" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblISINBP" runat="server" class="col-lg-2 text-center lbl">ISIN CON. BP:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblZCLIENTE" runat="server" class="col-lg-2 text-center lbl">CTA Emissão:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCNATJUR" runat="server" class="col-lg-2 text-center lbl">Natureza Juridica:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCIDABP" runat="server" class="col-lg-2 text-center lbl">COD. ADIC. BP:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCIDABP" runat="server" CssClass="form-control t-field-t" size="1"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCCUSTOD" runat="server" class="col-lg-2 text-center lbl">Custodiante:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCPAISEMI" runat="server" class="col-lg-2 text-center lbl">Pais Emitente:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblLGUARDA" runat="server" class="col-lg-2 text-center lbl">Local Guarda:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblRETEN" runat="server" class="col-lg-2 text-center lbl">% IRS/IRC:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtRETEN" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblPEXENCN" runat="server" class="col-lg-2 text-center lbl">% Isenção IRS:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblPAGRAVA" runat="server" class="col-lg-2 text-center lbl">% Agrava. IRS:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtPAGRAVA" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTISENIE" runat="server" class="col-lg-2 text-center lbl">% I. Estrang.:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTIRETEST" runat="server" class="col-lg-2 text-center lbl">% Isenção IE:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtTIRETEST" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTAGRAIE" runat="server" class="col-lg-2 text-center lbl">% Agrava. IE:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblICOTADO" runat="server" class="col-lg-2 text-center lbl">Tem Cotação:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbICOTADO" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblMOEDAVAL" runat="server" class="col-lg-2 text-center lbl">Moeda Liq.+Cotação:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFECHACTU" runat="server" class="col-lg-2 text-center lbl">Data Cot.:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtFECHACTU" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblIPERCOTA" runat="server" class="col-lg-2 text-center lbl">Periodicidade Cotação:</asp:Label>
                            <div class="col-lg-2">
                                <asp:TextBox ID="txtIPERCOTA" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                            <div class="col-lg-8">
                                <select id="cmbDPERCOTA" runat="server" cssclass="form-control t-field-t "></select>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblIORIGEMPREC" runat="server" class="col-lg-2 text-center lbl">Origem Preço:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblNEGOCIAV" runat="server" class="col-lg-2 text-center lbl">Negociável:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <%-- <div class="col-lg-6 ">
                            <asp:Label ID="lblCBOLSA01" runat="server" class="col-lg-2 text-center lbl">Bolsas:</asp:Label>
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCODPAIS" runat="server" class="col-lg-2 text-center lbl">Pais Mercad:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTIPTITUL" runat="server" class="col-lg-2 text-center lbl">Sist. Negocia.:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbTIPITUL" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblITSIZE" runat="server" class="col-lg-2 text-center lbl">Tick Size:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtITSIZE" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCINDPRI" runat="server" class="col-lg-2 text-center lbl">Indice Princ:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCINDSEC" runat="server" class="col-lg-2 text-center lbl">Indice Secun.:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblPISENCAO" runat="server" class="col-lg-2 text-center lbl">% Isenção Tx.Bol:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblIBANTELE" runat="server" class="col-lg-2 text-center lbl">Net:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbIBANTELE" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblITITBAL" runat="server" class="col-lg-2 text-center lbl">Agências:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTCREDITO" runat="server" class="col-lg-2 text-center lbl">Elegivel:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtTCREDITO" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFEALTCLI" runat="server" class="col-lg-2 text-center lbl">Data Criação:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFEULTMOD" runat="server" class="col-lg-2 text-center lbl">Ult. Actual:</asp:Label>
                            <div class="col-lg-2">
            ...
            <div class="row hidden">
                ...
                <div class="col-lg-12">
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblEMIS" runat="server" class="col-lg-2 text-center lbl">Data Emissão:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtEMIS" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFPROXA" runat="server" class="col-lg-2 text-center lbl">Dt. Ult. Mort.:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblDULTAMOR" runat="server" class="col-lg-2 text-center lbl">Dt. Amort. Final:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtDULTAMOR" runat="server" CssClass="form-control t-field-t "></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTIPAMOR" runat="server" class="col-lg-2 text-center lbl">Tipo Amortiz.:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTIPINT" runat="server" class="col-lg-2 text-center lbl">Tipo de Juro:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbTIPINT" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblINTERES" runat="server" class="col-lg-2 text-center lbl">% Juro:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFPRIMA" runat="server" class="col-lg-2 text-center lbl">Dt Pri Amort:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtFPRIMA" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTPRICE" runat="server" class="col-lg-2 text-center lbl">Pricing:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblINDEXANTE" runat="server" class="col-lg-2 text-center lbl">Index:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtINDEXANTE" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblNDIASINDX" runat="server" class="col-lg-2 text-center lbl">Num Dias Index:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTSPREAD" runat="server" class="col-lg-2 text-center lbl">Spread:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtTSPREAD" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCDAYCNT" runat="server" class="col-lg-2 text-center lbl">Conta. Dias:</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblQDIASMESCJ" runat="server" class="col-lg-2 text-center lbl">CDias Livre:</asp:Label>
                            <div class="col-lg-2">
                        ...
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblZJURANO" runat="server" class="col-lg-2 text-center lbl">Nº Juro/Ano:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTJURO7" runat="server" class="col-lg-2 text-center lbl">%Juro Anter:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtTJURO7" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblFPRIMC" runat="server" class="col-lg-2 text-center lbl">Dt Prim Juro:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblDTJUROSP" runat="server" class="col-lg-2 text-center lbl">Dt. Prox. Juro:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtDTJUROSP" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblDTJUROSA" runat="server" class="col-lg-2 text-center lbl">Dt. Utl. Juros:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCUPCORRC" runat="server" class="col-lg-2 text-center lbl">Juros Corrid:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbCUPCORRC" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblJURODLIQ" runat="server" class="col-lg-2 text-center lbl">Juro Diário:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblPRECOEMI" runat="server" class="col-lg-2 text-center lbl">Preço Emissão:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtPRECOEMI" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblDESDE" runat="server" class="col-lg-2 text-center lbl">Qtd. Emitida:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblLOTEMIN" runat="server" class="col-lg-2 text-center lbl">Lote Minimo:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtLOTEMIN" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCODBAN" runat="server" class="col-lg-2 text-center lbl">Banco Lider:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCRATFITCH" runat="server" class="col-lg-2 text-center lbl">Rating Fitch:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCRATFITCH" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCRATMOODY" runat="server" class="col-lg-2 text-center lbl">Rating Moody:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCRATSP" runat="server" class="col-lg-2 text-center lbl">Rating S&P:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtCRATSP" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCSENIOR" runat="server" class="col-lg-2 text-center lbl">Senioridade:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblIALAVANC" runat="server" class="col-lg-2 text-center lbl">Alavancagem:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbIALAVANC" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCTIPMERC" runat="server" class="col-lg-2 text-center lbl">Tipo de Mercado:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblISUBJACENT" runat="server" class="col-lg-2 text-center lbl">Subjacente:</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbISUBJACENT" runat="server" class="form-control t-field-t"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblCMIC" runat="server" class="col-lg-2 text-center lbl">Mercado de Admissão:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-4">
                            <asp:Label ID="CondReembolso" runat="server" class="col-lg-2 text-center lbl">Condições de Reembolso:</asp:Label>
                        </div>
                        <div class="col-lg-8">
                            <asp:Label ID="lblICONDMAT" runat="server" class="col-lg-2 text-center lbl">MAT</asp:Label>
                            <div class="col-lg-2">
                                <select id="cmbICONDMAT" runat="server" class="form-control t-field-t" maxlength="9"></select>
                            </div>
                            <asp:Label ID="lblICONDCAL" runat="server" class="col-lg-2 text-center lbl">CAL</asp:Label>
                            <div class="col-lg-2">
                                <select id="cmbICONDCAL" runat="server" class="form-control t-field-t" maxlength="9"></select>
                            </div>
                            <asp:Label ID="lblICONDPUT" runat="server" class="col-lg-2 text-center lbl">PUT</asp:Label>
                            <div class="col-lg-2">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblICONDRAA" runat="server" class="col-lg-2 text-center lbl">RAA</asp:Label>
                            <div class="col-lg-4">
                                <select id="cmbICONDRAA" runat="server" class="form-control t-field-t" maxlength="9"></select>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblICONDOUT" runat="server" class="col-lg-2 text-center lbl">OUT</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="Label1" runat="server" class="col-lg-2 text-center lbl"></asp:Label>
                            <div class="col-lg-4">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDFEADMISS" runat="server" class="col-lg-2 text-center lbl">Dt. ADM Negoc.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDFEADMISS" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDFEULTNEG" runat="server" class="col-lg-2 text-center lbl">Dt. Ult. Negoc:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDFEULTNEG" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDZEXERCANO" runat="server" class="col-lg-2 text-center lbl">Nº Exerc/Ano:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDFEVENCIM" runat="server" class="col-lg-2 text-center lbl">Dt. Prim. Exer.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDFEVENCIM" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDEXERCP" runat="server" class="col-lg-2 text-center lbl">Dt. Pro. Exer.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDEXERCP" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDEXERCA" runat="server" class="col-lg-2 text-center lbl">Dt. Ult. Exer.:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDZEXERC" runat="server" class="col-lg-2 text-center lbl">Num. Exercic.:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDPERCENT" runat="server" class="col-lg-2 text-center lbl">Factor Conv.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDPERCENT" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDNOVCODVA" runat="server" class="col-lg-2 text-center lbl">Activo Subja.:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDSTRIKE" runat="server" class="col-lg-2 text-center lbl">Preço Exerci.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtWDSTRIKE" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblWDARREDOD" runat="server" class="col-lg-2 text-center lbl">Tipo Arredon.:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlDadsCompWarrAUtoContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblITIPOWAR" runat="server" class="col-lg-2 text-center lbl">Tipo Warrant:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <select id="cmbITIPOWAR" runat="server" class="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblIESTWAR" runat="server" class="col-lg-2 text-center lbl">Estilo Warrant:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <select id="cmbIESTWAR" runat="server" class="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="Label3" runat="server" class="col-lg-2 text-center lbl"></asp:Label>
                </td>
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblITIPEXER" runat="server" class="col-lg-2 text-center lbl">Tipo Exercicio:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblFEADMISS" runat="server" class="col-lg-2 text-center lbl">Dt. Adm. Negoc.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtFEADMISS" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblFEULTNEG" runat="server" class="col-lg-2 text-center lbl">Dt. Ultima Negoc.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtFEULTNEG" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblFEVENCIM" runat="server" class="col-lg-2 text-center lbl">Dt de Vencimento:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblPARIDADE" runat="server" class="col-lg-2 text-center lbl">Paridade War:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtPARIDADE" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblQLOTEMIN" runat="server" class="col-lg-2 text-center lbl">Lote Min. Exe.:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblNACTSUBJ" runat="server" class="col-lg-2 text-center lbl">Ind. Activo Subj.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                ...
                <td class="t-table-col-1">
                    ...
                    <asp:Label ID="lblCMOESUBJ" runat="server" class="col-lg-2 text-center lbl">Moeda Activo Subjacente:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCTIPOLIQ" runat="server" class="col-lg-2 text-center lbl">Tipo Liquida:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <select id="cmbCTIPOLIQ" runat="server" class="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblSTRIKE" runat="server" class="col-lg-2 text-center lbl">Preço Exerci.:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblNEMITEN" runat="server" class="col-lg-2 text-center lbl">Nome do Emitente:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlDadsCompContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblTFACTOR" runat="server" class="col-lg-2 text-center lbl">Paridade/QTD.:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtTFACTOR" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblIACTSUB" runat="server" class="col-lg-2 text-center lbl">Activo Subjacente:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <select id="cmbIACTSUB" runat="server" class="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblGTFACTOR" runat="server" class="col-lg-2 text-center lbl">Nome Activo Subjacente:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblTEXTOL" runat="server" class="col-lg-2 text-center lbl">Texto Livre:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlDadosTecContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lbPrincing" runat="server" class="col-lg-2 text-center lbl">Princing:</asp:Label>
                </td>
            </tr>

            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblPROVIDER" runat="server" class="col-lg-2 text-center lbl">Provider:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtPROVIDER" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="lblSOURCE" runat="server" class="col-lg-2 text-center lbl">Source:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlDadsCompEleContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCELEGIB1" runat="server" class="form-control t-field-t">1. Prioridade Elegilidade:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <select id="cmbCELEGIB1" runat="server" class="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
                    <asp:Label ID="Label4" runat="server" class="form-control t-field-t"></asp:Label>
                </td>
                <td class="t-table-col-2"></td>
                <td class="t-table-col-1">
                    <asp:Label ID="Label5" runat="server" class="form-control t-field-t"></asp:Label>
                </td>
                <td class="t-table-col-2"></td>
            </tr>
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCELEGIB2" runat="server" class="form-control t-field-t">2. Prioridade Elegilidade:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCELEGIB3" runat="server" class="form-control t-field-t">3. Prioridade Elegilidade:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCELEGIB4" runat="server" class="form-control t-field-t">4. Prioridade Elegilidade:</asp:Label>
                </td>
                <td class="t-table-col-2">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCELEGIB5" runat="server" class="form-control t-field-t">5. Prioridade Elegilidade:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlDadosCompImpContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            ...
            <tr>
                ...
                <td class="t-table-col-1">
                    <asp:Label ID="lblCODFTT" runat="server" class="col-lg-2 text-center lbl">Referência FIT:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <asp:Panel ID="pnlAttInvContent" runat="server" Visible="false">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" class="t-table-0">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblCSUBFAM" runat="server" class="col-lg-2 text-center lbl">SubFamilia:</asp:Label>
                </td>
                <td class="t-table-col-2">
                    <asp:TextBox ID="txtCSUBFAM" runat="server" CssClass="form-control t-field-t"></asp:TextBox>
                    <select id="cmbCSUBFAM" runat="server" cssclass="form-control t-field-t"></select>
                </td>
                <td class="t-table-col-1">
            ...
            <tr>
                <td class="t-table-col-1">
                    <asp:Label ID="lblIRECOMEND" runat="server" class="col-lg-2 text-center lbl">Produto recomendado:</asp:Label>
                </td>
                <td class="t-table-col-2">
    ...
    <hr class="hr" />
    <br />
    <div class="btnLeft" runat="server" id="cleanSave">
    </div>
    <br />
    <br />
