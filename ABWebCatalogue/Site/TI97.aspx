    ...
    <br />
     ...
     <asp:Panel ID="pnlSearch" runat="server">
                ...
                <tr>
                   <td class="t-table-col-1">
                    ...
                    <td class="t-table-col-2"></td>
                        <td class="t-table-col-1">
                        <asp:Label ID="Label11" runat="server" class="t-label-1"></asp:Label>
                    </td>
                    <td class="t-table-col-2"></td>
                    </tr>
                <tr>
            ...
            <div class="divCollapseLeft">
                <button id="searchButton" class="btnCollapse" runat="server" onserverclick="btnSearchButton_Click">Search</button>
        ...
        <asp:Panel ID="pnlContent" runat="server">
            <table width="100%" cellpadding="0" cellspacing="0" class="t-table-0">
                ...
                <tr>
                    <td class="t-table-col-1">
                        <asp:Label ID="lblAMORPARC" runat="server" class="t-label-1">Amort. Parcial sem Afeta Nom/Quant.:</asp:Label>
                    </td>
                    <td class="t-table-col-2">
                        <asp:TextBox ID="txtAMORPARC" runat="server" CssClass="t-field-14 "></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="t-table-col-2">
                        <asp:TextBox ID="txtCBOLSA01" runat="server" CssClass="t-field-14 "></asp:TextBox>
                        <asp:TextBox ID="txtCBOLSA02" runat="server" CssClass="t-field-14 "></asp:TextBox>
                        <asp:TextBox ID="txtCBOLSA03" runat="server" CssClass="t-field-14 "></asp:TextBox>
                        <asp:TextBox ID="txtCBOLSA04" runat="server" CssClass="t-field-14 "></asp:TextBox>
                        <asp:TextBox ID="txtCBOLSA05" runat="server" CssClass="t-field-14 "></asp:TextBox>
                        <asp:TextBox ID="txtCBOLSA06" runat="server" CssClass="t-field-14 "></asp:TextBox>
