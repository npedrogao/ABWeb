            ...
            <div id="pnlSearchContent" runat="server" class="hidden">
                ...
                <div class="row hidden closeAccordion">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-4">
                                <asp:Label ID="CondReembolso" runat="server" class="col-lg-2 text-right lbl">Condições de Reembolso:</asp:Label>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="row form-group padding-row">
                            <div class="col-lg-6 ">
                                <asp:Label ID="Label1" runat="server" class="col-lg-2 text-right lbl"></asp:Label>
                                <div class="col-lg-4">
                ...
                <div class="row hidden closeAccordion">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTFACTOR" runat="server" class="col-lg-2 text-right lbl">Paridade/QTD.:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtTFACTOR" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblIACTSUB" runat="server" class="col-lg-2 text-right lbl">Activo Subjacente:</asp:Label>
                            <div class="col-lg-4">
                    ...
                    <div class="row form-group padding-row">
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblGTFACTOR" runat="server" class="col-lg-2 text-right lbl">Nome Activo Subjacente:</asp:Label>
                            <div class="col-lg-4">
                                <asp:TextBox ID="txtGTFACTOR" runat="server" CssClass="form-control t-field-t" MaxLength="9"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <asp:Label ID="lblTEXTOL" runat="server" class="col-lg-2 text-right lbl">Texto Livre:</asp:Label>
                            <div class="col-lg-4">
