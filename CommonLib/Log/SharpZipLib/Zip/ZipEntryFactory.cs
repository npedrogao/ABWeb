...
using System;
using System.IO;
using CommonLib.Log.SharpZipLib.Core;
...
namespace CommonLib.Log.SharpZipLib.Zip
{
    ...
    public class ZipEntryFactory : IEntryFactory
    {
        ...
        public INameTransform NameTransform
        {
            ...
            set {
                this.nameTransform_ = value ?? new ZipNameTransform();
            }
        }
        ...
        public ZipEntry MakeFileEntry(string fileName)
        {
            ...
            ZipEntry result = new ZipEntry(this.nameTransform_.TransformFile(fileName)) {Size = fi.Length};

            int externalAttributes = ((int) fi.Attributes & this.getAttributes_);
        ...
        public ZipEntry MakeDirectoryEntry(string directoryName)
        {
            ...
            ZipEntry result = new ZipEntry(this.nameTransform_.TransformDirectory(directoryName));

            int externalAttributes = ((int) di.Attributes & this.getAttributes_);
            externalAttributes |= this.setAttributes_;
