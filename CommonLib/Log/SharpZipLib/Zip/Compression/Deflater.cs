...
namespace CommonLib.Log.SharpZipLib.Zip.Compression
{
    ...
    public class Deflater
    {
		...
		*/
        ...
        public int TotalIn
        {
            get { return this.engine.TotalIn; }
        }
        ...
        {
            get { return (this.state == FINISHED_STATE) && this.pending.IsFlushed; }
        }
        ...
        {
            get { return this.engine.NeedsInput(); }
        }
        ...
        {
            if (inLevel == DEFAULT_COMPRESSION)
            {
                inLevel = 6;
            }
            else if (inLevel < NO_COMPRESSION || inLevel > BEST_COMPRESSION)
            {
                throw new ArgumentOutOfRangeException("inLevel");
            }
