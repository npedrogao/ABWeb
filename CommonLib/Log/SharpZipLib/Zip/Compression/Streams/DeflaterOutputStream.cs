...
namespace CommonLib.Log.SharpZipLib.Zip.Compression.Streams
{
    ...
    public class DeflaterOutputStream : Stream
    {
        ...
        {
            get { return this.baseOutputStream.CanSeek; }
        }
        ...
        public virtual void Finish()
        {
            ...
            {
                int len = this.def.Deflate(this.buffer_, 0, this.buffer_.Length);
                if (len <= 0)
                {
                    break;
                }
                ...
                this.baseOutputStream.Write(this.buffer_, 0, len);
            }
        ...
        /// </summary>
        protected void InitializePassword(string inPassword)
        {
            this.keys = new uint[]
                            {
                                0x12345678,
            ...
            byte[] rawPassword = ZipConstants.ConvertToArray(inPassword);

            for (int i = 0; i < rawPassword.Length; ++i)
            {
                this.UpdateKeys(rawPassword[i]);
            }
        }
        ...
        protected void Deflate()
        {
            ...
            {
                int deflateCount = this.def.Deflate(this.buffer_, 0, this.buffer_.Length);
                ...
                this.baseOutputStream.Write(this.buffer_, 0, deflateCount);
            }
        ...
        {
            get { return this.baseOutputStream.CanWrite; }
        }
        ...
        {
            get { return this.baseOutputStream.Length; }
        }
        ...
        {
            get { return this.baseOutputStream.Position; }
        ...
        {
            this.def.SetInput(buffer, inOffset, count);
            this.Deflate();
        }
