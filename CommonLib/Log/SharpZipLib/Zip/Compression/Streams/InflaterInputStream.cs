...
namespace CommonLib.Log.SharpZipLib.Zip.Compression.Streams
{
    /// <summary>
    ...
    public class InflaterInputBuffer
    {
        ...
        {
            get { return this.clearTextLength; }
        }
        ...
        public void Fill()
        {
            ...
            {
                this.clearTextLength = this.cryptoTransform.TransformBlock(this.rawData, 0, this.rawLength,
                                                                           this.clearText, 0);
            }
            else 
#endif
        ...
        public int ReadRawBuffer(byte[] outBuffer, int offset, int length)
        {
            ...
            while (currentLength > 0)
            {
                ...
                Array.Copy(this.rawData, this.rawLength - this.available, outBuffer, currentOffset, toCopy);
        ...
        public int ReadClearTextBuffer(byte[] outBuffer, int offset, int length)
        {
            ...
            while (currentLength > 0)
            {
                ...
                int toCopy = Math.Min(currentLength, this.available);
                Array.Copy(this.clearText, this.clearTextLength - this.available, outBuffer, currentOffset, toCopy);
                currentOffset += toCopy;
                currentLength -= toCopy;
                this.available -= toCopy;
            }
        ...
        public int ReadLeByte()
        {
            ...
            byte result = (byte) (this.rawData[this.rawLength - this.available] & 0xff);
            this.available -= 1;
            return result;
        }
        ...
        public ICryptoTransform CryptoTransform
        {
            set
            {
                ...
                if (this.cryptoTransform != null)
                {
                    ...
                    if (this.available > 0)
                    {
                        this.cryptoTransform.TransformBlock(this.rawData, this.rawLength - this.available,
                                                            this.available, this.clearText,
                                                            this.rawLength - this.available);
                    }
                }
                else
                {
    ...
    /// as the <see cref="CommonLib.Log.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
    ///
    ...
    public class InflaterInputStream : Stream
    {
        ...
        {
            get { return this.inf.IsFinished ? 0 : 1; }
        }
        ...
        public long Skip(long count)
        {
            ...
            return this.baseInputStream.Read(tmp, 0, tmp.Length);
        }
        ...
        {
            get { return this.baseInputStream.CanRead; }
        }
        ...
        {
            get { return this.inputBuffer.RawLength; }
        }
        ...
        {
            get { return this.baseInputStream.Position; }
