...
namespace CommonLib.Log.SharpZipLib.GZip
{
    /// <summary>
    ...
    /// using System.IO;
    /// 
    /// using CommonLib.Log.SharpZipLib.GZip;
    ...
    public class GZipOutputStream : DeflaterOutputStream
    {
        ...
        /// <param name="inOffset">Offset of first byte in buf to write</param>
        ...
        public override void Finish()
        {
            ...
            int crcval = (int) (this.crc.Value & 0xffffffff);
            ...
            this.baseOutputStream.Write(gzipFooter, 0, gzipFooter.Length);
        ...
        private void WriteHeader()
        {
            if (!this.headerWritten_)
            {
                ...
                this.baseOutputStream.Write(gzipHeader, 0, gzipHeader.Length);
            }
        }
